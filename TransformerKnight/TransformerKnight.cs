...
{
    public class TransformerKnight:Mod,ICustomMenuMod
    {
        internal static TransformerKnight Instance;
        ...
        private static readonly List<float> TransformerKnightValues = new List<float>()
        {
            0.5f,
            1f,
            2.5f,
        ...
        private void HeroUpdate()
        {
            if (settings.keybinds.Transform.WasPressed)
            {
                ...
                currentScale = TransformerKnightValues[currentTransformation % 3];
            }
